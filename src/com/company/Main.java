...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    ArrayList<SalariedEmployee> salaried_employees = new ArrayList<SalariedEmployee>();
    ArrayList<HourlyEmployee> hourly_employees = new ArrayList<HourlyEmployee>();
    ArrayList<CommissionedEmployee> commissioned_employees = new ArrayList<CommissionedEmployee>();
